...
@property(nonatomic, strong)UIView *rateSelectView;
...
- (void)setupSubviewsWithUIConfig:(AlivcRecordUIConfig *)uiConfig{
    //速度选择条
    _rateSelectView =[[UIView alloc]initWithFrame:CGRectMake(30, 0, ScreenWidth-60, 40)];
    _recordButttonView.backgroundColor = [UIColor redColor];
    [self addSubview:_rateSelectView];
    
    //拍摄模式选择
    _toolView =[[AlivcRecordToolView alloc]initWithFrame:CGRectMake(0, CGRectGetHeight(self.frame) -50, ScreenWidth, 50)];
    ...
    _beautyBtn.userInteractionEnabled = NO;
    ...
    _pasterBtn.userInteractionEnabled = NO;
